...
dat = expand.name(read_csv('../results/sequential_mnist_prod.csv')) %>%
  gather(
    key="extrapolation.length", value="extrapolation.error",
    loss.valid.extrapolation.1, loss.valid.extrapolation.2, loss.valid.extrapolation.3,
    loss.valid.extrapolation.5, loss.valid.extrapolation.6,
    loss.valid.extrapolation.7, loss.valid.extrapolation.8, loss.valid.extrapolation.9
  ) %>%
  mutate(
