...
#experiment_names=( 'function_task_static' 'function_task_static_learning' 'function_task_static_ablation' 'function_task_static_mul_hidden_size' 'function_task_static_mul_hidden_size_ablation' 'function_task_static_mul_input_size' 'function_task_static_mul_overlap' 'function_task_static_mul_subset' 'function_task_static_mul_range' 'function_task_static_regualization' 'simple_mul' )
experiment_names=( 'function_task_static_mul_hidden_size' )
