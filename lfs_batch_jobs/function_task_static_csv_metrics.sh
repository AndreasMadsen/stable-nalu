...
experiment_names=( 'function_task_static_mul_range'  )
for experiment_name in "${experiment_names[@]}"
do
    bsub -q hpc -n 16 -W 3:00 -J ${job_name} -o /work3/$USER/logs/${job_name}/ -e /work3/$USER/logs/${job_name}/ -R "span[hosts=1]" -R "rusage[mem=10GB]" ./python_lfs_job.sh \
