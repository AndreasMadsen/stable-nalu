...
#mnist_outputs=( 1 2 3 4 5 6 8 10 )
mnist_outputs=( 1 2 3 4 )

for seed in {0..4}
do
    for mnist_output_size in "${mnist_outputs[@]}"
    do
        bsub -q gpuv100 -n 2 -gpu "num=1:mode=exclusive_process" -W 6:00 -J ${experiment_name} -o /work3/$USER/logs/${experiment_name}/ -e /work3/$USER/logs/${experiment_name}/ -R "span[hosts=1]" -R "rusage[mem=10GB]" ./python_lfs_job.sh \
