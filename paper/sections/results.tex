...
We evaluate validation, test, and sparsity error every $1000$ iterations. To avoid noise from exploration, the best fit in terms of the validation error, among the last $100$ evaluations, is used for testing if the model succeeded and its sparsity error.
