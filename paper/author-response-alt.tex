...
\begin{minipage}{.48\textwidth}
  ...
  \vspace{-0.65cm}
  \captionof{figure}{Shows ability to extrapolate to a given sequence length, trained on sequence length 2. Sparsity error excluded due to space constraints.}
  \label{fig:test2}
\end{minipage}
\end{figure}
