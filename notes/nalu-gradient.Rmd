...
&= g_{h_{\ell+1}} \frac{\partial a_{h_{\ell+1}}}{\partial z_{h_\ell}} + (1 - g_{h_{\ell+1}}) \frac{\partial m_{h_{\ell+1}}}{\partial z_{h_\ell}} + (a_{h_{\ell+1}} - m_{h_{\ell+1}}) \frac{\partial a_{h_{\ell+1}}}{\partial z_{h_\ell}}
\end{aligned}
$$
...
$$
\frac{\partial m_{h_{\ell+1}}}{\partial z_{h_\ell}} = \exp\left(\sum_{h_{\ell}=1}^{H_{\ell}} W_{h_{\ell+1}, h_{\ell}} \log(|z_{h_{\ell}}| + \epsilon) \right) W_{h_{\ell+1}, h_{\ell}} \frac{\mathrm{abs}'(z_{h_{\ell}})}{|z_{h_{\ell}}| + \epsilon}
$$

### The gate

$$
\frac{\partial g_{h_{\ell+1}}}{\partial z_{h_\ell}} = \frac{\partial g_{h_{\ell+1}}}{\partial \hat{g}_{h_{\ell+1}}} \frac{\partial \hat{g}_{h_{\ell+1}}}{\partial z_{h_\ell}} = \sigma(\hat{g}_{h_{\ell+1}}) (1 - \sigma(\hat{g}_{h_{\ell+1}})) G_{h_{\ell+1},h_{\ell}}
$$
